export class stringHandler {
	...
	constructor(str: string, chunkSize: number = 800, title?: string, secondaryTitle?: string, code: string = '', timestamp?: Date) {
		...
		for (let i = 0; i <= this.length; i++)
			...
			else this.chunks.push(this.decorate(str.substring(i * chunkSize, (i + 1) * chunkSize), i));
	}
