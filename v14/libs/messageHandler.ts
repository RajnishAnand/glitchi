...
export async function messageHandler(
  ...
  if (msg.author.bot || msg.channel.type == ChannelType.DM || !msg.guild)
    return;
  ...
  const command =
    client.textCommands.get(commandName) || client.aliases.get(commandName);
