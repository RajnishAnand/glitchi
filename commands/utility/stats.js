...
module.exports = {
  ...
  execute({msg,args,client}){
    ...
    try{
      ...
      stats.push(`**Servers** : ${client.guilds.cache.size}`);
      stats.push(`**Channels** : ${client.channels.cache.size}`);
      stats.push(`**Users** : ${client.users.cache.size}`)
      
      uptime.push(`**Client** : ${prettyMs(client.uptime)}`);
